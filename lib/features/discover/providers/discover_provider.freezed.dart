...
mixin _$DiscoverState {
  ...
  DiscoverBundle? get bundle => throw _privateConstructorUsedError;
...
abstract class $DiscoverStateCopyWith<$Res> {
  ...
  $DiscoverBundleCopyWith<$Res>? get bundle;
}
...
class _$DiscoverStateCopyWithImpl<$Res, $Val extends DiscoverState>
  ...
  $DiscoverBundleCopyWith<$Res>? get bundle {
    ...
    return $DiscoverBundleCopyWith<$Res>(_value.bundle!, (value) {
...
class _$DiscoverStateImpl implements _DiscoverState {
  ...
  @override
  String toString() {
    return 'DiscoverState(status: $status, bundle: $bundle, recentSearches: $recentSearches, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, bundle,
      const DeepCollectionEquality().hash(_recentSearches), errorMessage);
...
abstract class _DiscoverState implements DiscoverState {
  const factory _DiscoverState(
      ...
      final String? errorMessage}) = _$DiscoverStateImpl;

  @override
  DiscoverStatus get status;
  @override
  DiscoverBundle? get bundle;
  @override
  List<String> get recentSearches;
  @override
